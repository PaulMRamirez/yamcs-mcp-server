...
class TestObjectStorageComponent:
    ...
    @pytest.mark.asyncio
    async def test_object_list_buckets(
        self, storage_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_object_list_objects(
        self, storage_component, mock_server, mock_yamcs_client
    ):
        ...
        assert result["objects"][0]["metadata"] == {
            "type": "telemetry", "source": "simulator"
        }
    ...
    @pytest.mark.asyncio
    async def test_object_list_objects_limit(
        self, storage_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_object_get_object(
        self, storage_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_object_put_object(
        self, storage_component, mock_server, mock_yamcs_client
    ):
        ...
        assert result["size"] == len(b'{"key": "value"}')
    ...
    @pytest.mark.asyncio
    async def test_object_delete_object(
        self, storage_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_object_get_metadata(
        self, storage_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_object_get_metadata_not_found(
        self, storage_component, mock_server, mock_yamcs_client
    ):
    ...
    async def test_error_handling(
        ...
        # Mock an error
        mock_yamcs_client.get_storage_client.side_effect = Exception(
            "Storage unavailable"
        )
