...
class TestArchiveComponent:
    ...
    @pytest.mark.asyncio
    async def test_archive_query_parameters(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_archive_get_parameter_samples(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_archive_query_events(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_archive_query_events_with_filters(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_missing_attributes_handling(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_empty_results(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_error_handling(self, archive_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_parameter_data_structure(self, archive_component, mock_server, mock_yamcs_client):
        ...
        # Test case where ParameterData has multiple parameters (shouldn't happen for single param query)
        ...
        mock_archive.stream_parameter_values.return_value = [mock_data_empty, mock_data_multi]
        mock_yamcs_client.get_archive.return_value = mock_archive
