...
class TestInstanceManagementComponent:
    ...
    @pytest.mark.asyncio
    async def test_instance_list_instances(
        self, instances_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_instance_get_info(
        self, instances_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_instance_get_info_default(
        self, instances_component, mock_server, mock_yamcs_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_instance_start_stop(
        self, instances_component, mock_server, mock_yamcs_client
    ):
    ...
    async def test_resource_handlers(
        ...
        assert (
            "CommandHistory [RUNNING]: org.yamcs.cmdhistory.CommandHistoryService "
            "(processor: realtime)" in result
        )
