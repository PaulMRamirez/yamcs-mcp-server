...
class TestProcessorComponent:
    ...
    @pytest.mark.asyncio
    async def test_processor_list_processors(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_get_status(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_get_status_no_stats(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_issue_command(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_issue_command_dry_run(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_get_parameter_value(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_get_parameter_value_missing_attrs(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_processor_set_parameter_value(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_resource_handler(self, processor_component, mock_server, mock_yamcs_client):
    ...
    @pytest.mark.asyncio
    async def test_error_handling(self, processor_component, mock_server, mock_yamcs_client):
